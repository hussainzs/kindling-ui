...
export default function InterventionPopup({ open, onClose }: { open: boolean; onClose: () => void }) {
      ...
      <div className="intervention-modal-card">
        <div className="intervention-modal-content">
          ...
          <div className="intervention-modal-left">
            ...
            <h1 className="intervention-title intervention-title-gradient">this is the ugly middle...</h1>
            <p className="intervention-desc">
              but everyone goes through it.<br />
              <span className="intervention-desc-bold">that’s the <span className="intervention-desc-highlight">process, not failure.</span></span><br />
              the struggle means you’re in something real. look how far you’ve already come.
            </p>
            <div className="intervention-progress-row">
              <div className="intervention-progress-group">
                ...
                <span className="intervention-progress-label">where you started · 0/3 milestones</span>
              </div>
              <div className="intervention-progress-group">
                <div className="intervention-progress-img intervention-progress-img-current" />
                <span className="intervention-progress-label">&nbsp;</span>
                <span className="intervention-progress-label intervention-progress-label-current">where you are right now · 0/3 milestones</span>
              </div>
            </div>
          </div>
          {/* Right column */}
          <div className="intervention-modal-right">
            ...
            <div className="intervention-modal-actions">
              <button className="intervention-modal-btn intervention-modal-btn-secondary" onClick={onClose}>
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5em' }}>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.8335 15.8333V14.1667H11.7502C12.6252 14.1667 13.3856 13.8889 14.0314 13.3333C14.6772 12.7778 15.0002 12.0833 15.0002 11.25C15.0002 10.4167 14.6772 9.72223 14.0314 9.16668C13.3856 8.61112 12.6252 8.33334 11.7502 8.33334H6.50016L8.66683 10.5L7.50016 11.6667L3.3335 7.50001L7.50016 3.33334L8.66683 4.50001L6.50016 6.66668H11.7502C13.0974 6.66668 14.2536 7.10418 15.2189 7.97918C16.1842 8.85418 16.6668 9.94445 16.6668 11.25C16.6668 12.5556 16.1842 13.6458 15.2189 14.5208C14.2536 15.3958 13.0974 15.8333 11.7502 15.8333H5.8335Z" fill="#6B5D52"/>
                  </svg>
                  keep going
                </span>
              </button>
              <button className="intervention-modal-btn intervention-modal-btn-primary" onClick={onClose}>
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5em' }}>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
